...
\begin{proof}
    ...
    \prepp{Is contractible implies final obvious?}
    ...
    \prepp{I should maybe do this for all four vertices, or at least check how different the argument is for another vertex.}
