...
\begin{document}
\TODO{Say something vague about what Verdier duality is and what we will do here.}
...
\begin{remark}
    ...
    Volpe uses the functors $f_*$ and $f^*$ on $\C^{op}$, which takes cosheaves to cosheaves, to obtain the functors $f_!$ and $f^!$ and use Theorem \ref{VerdierDuality} to transfer the adjunction to the level of sheaves.
\end{remark}
\begin{remark}
