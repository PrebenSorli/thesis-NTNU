...
This can be shown directly and the interested reader can see for example \cite[Proposition 4.10.]{Rezk} or \cite[\href{https://kerodon.net/tag/002Y}{Subsection 002Y}]{kerodon} for proofs, but we will instead delay the proof to chapter \ref{kanchap} to illustrate the usefulness of Kan extensions.
...
\begin{definition}
    ...
    \[\begin{tikzcd}
        ...
        \end{tikzcd}\]
    which, in fact, is an actual space.
\end{definition}
