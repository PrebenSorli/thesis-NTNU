...
\begin{proof}
    ...
    \]
    \help{Honestly I did not understand how we applied 4.2.3.4 or your explanation of how we get a cocartesian fibration or even how a cocartesian fibration helps.}
\end{proof}
\end{document}